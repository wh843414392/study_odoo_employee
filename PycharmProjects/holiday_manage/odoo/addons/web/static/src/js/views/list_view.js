...
var ListView = View.extend( /** @lends instance.web.ListView# */ {
    ...
    load_list: function(data) {
        ...
        //实现从详情返回当前页 -- muse team
        if(sessionStorage.getItem('muse-page') && sessionStorage.getItem('muse-view-name') == self.name) {

            self.page = parseInt(sessionStorage.getItem('muse-page'));

            sessionStorage.removeItem('muse-page');
            sessionStorage.removeItem('muse-view-name');
        }
    ...
    select_record:function (index, view) {
        ...
        //选择记录时，保存当前页数 -- muse team
        sessionStorage.setItem('muse-page', this.page);
        sessionStorage.setItem('muse-view-name', this.name);
